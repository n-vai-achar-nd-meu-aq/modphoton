...
public class ModphotonModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<CtmdTileEntity>> CTMD = REGISTRY.register("ctmd", () -> BlockEntityType.Builder.of(CtmdTileEntity::new, ModphotonModBlocks.CTMD.get()).build(null));
