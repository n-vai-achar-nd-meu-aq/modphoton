package net.mcreator.modphoton.block.entity;
...
public class CtmdTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(CtmdBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CtmdTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CtmdTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
